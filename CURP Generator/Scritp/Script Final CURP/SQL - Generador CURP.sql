...
------------------------------------------------------------------------------------------
-- 1    | -         | 2019-04-25    | ELiusq                | Creación
-- 2    | -         | 2019-05-14    | ELiusq                | Terminación
...
IF @ConsonanteIntAP1 IN ('B','C','D','F','G','H','J','K','L','M','N','P','Q','R','S','T','V','W','X','Y','Z')
...
END
 ...
 IF  @ConsonanteIntAP1 IN ('A','E','I','O','U')
BEGIn SET @ConsonanteIntAP2 = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@P_APaterno, 'A', ''), 'E', ''), 'O', ''), 'U', ''), 'I', '')
...
IF @ConsonanteInt1 IN ('B','C','D','F','G','H','J','K','L','M','N','P','Q','R','S','T','V','W','X','Y','Z')
...
END
 ...
 IF  @ConsonanteInt1 IN ('A','E','I','O','U')
BEGIn SET @ConsonanteInt2 = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@P_Nombre, 'A', ''), 'E', ''), 'O', ''), 'U', ''), 'I', '')
